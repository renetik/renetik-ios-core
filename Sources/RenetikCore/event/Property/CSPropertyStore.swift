...
//
public protocol CSPropertyStore {
//    func property(key: String, value: String,
//                  onChange: ((_ value: String) -> Unit)?) -> CSEventProperty<String>

//    func property(key: String, value: Boolean,
//                  onChange: ((_ value: Boolean) -> Unit)?) -> CSEventProperty<Boolean>
}

public extension CSPropertyStore {
//    func property(key: String, value: String) -> CSEventProperty<String> {
//        property(key: key, value: value, onChange: nil)
//    }

//    func property(key: String, value: Boolean) -> CSEventProperty<Boolean> {
//        property(key: key, value: value, onChange: nil)
//    }
}

//interface CSPropertyStore {
//
//    fun property(
