...
public extension String {
    static let cs_dialog_ok = localized("cs_dialog_ok")
    static let cs_dialog_yes = localized("cs_dialog_yes")
    static let cs_dialog_no = localized("cs_dialog_no")
    static let cs_dialog_cancel = localized("cs_dialog_cancel")

    static let requestRetry = localized("cs_request_retry")
    static let requestCancel = localized("cs_request_cancel")
    static let requestFailed = localized("cs_request_failed_message")
    static let requestLoading = localized("cs_request_loading")

    static let tableLoadNextFailed = localized("cs_table_load_next_failed_message")

    static let operationCancelled = localized("cs_operation_canceled_message")
    static let operationFailed = localized("cs_operation_failed_message")

    static let searchPlaceholder = localized("cs_search_placeholder")
