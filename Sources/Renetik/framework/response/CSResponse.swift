...
public class CSResponse<Data: CSAnyProtocol>: NSObject, CSResponseProtocol {
...
//    var form: ((_ formData: AFMultipartFormData) -> Void)?
    ...
    public func onSuccess(_ onSuccess: @escaping Func) {
        onSuccessEvent.listen { _ in onSuccess() }
    }
    ...
    @discardableResult
    public func failIfFail<Data: CSAnyProtocol>(_ response: CSResponse<Data>) -> CSResponse<Data> {
