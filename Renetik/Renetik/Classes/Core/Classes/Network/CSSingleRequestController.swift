...
//public class CSSingleRequestController<Data: AnyObject>: CSChildViewLessController {
//
...
//                .onFailed { _ in
//                    if self.data.notNil {
//                        self.show(title: TextMessage.requestFailMessage,
//                                message: "Zopakovat ?", "Ne", "Ano", self.reload)
//                    } else {
//                        self.show(message: TextMessage.requestFailMessage, self.reload)
//                    }
