...
- (void)showTitle:(NSString *)title message:(NSString *)message
    ...
    negativeTitle:(NSString *)negativeTitle onCanceled:(nullable void (^)())onCanceled
NS_SWIFT_NAME(show(title:message:positiveTitle:onPositive:negativeTitle:onCanceled:));
