...
//    return [CSJsonDictionary createArray :type :[self getArray :arrayKey]];
//}
//
//- (NSMutableArray<NSMutableArray<CSDictionaryJsonData *> *> *)createArrayOfArray :(Class)type
//                                                                             key :(NSString *)arrayKey {
//    return [CSJsonDictionary createArrayOfArray :type :[self getArray :arrayKey]];
//}
//
//- (NSMutableArray<CSDictionaryJsonData *> *)createArray :(Class)type dictionaryId :(NSString *)dictionaryId {
//    return [CSJsonDictionary createArray :type fromDictionary :[self getDictionary :dictionaryId]];
//}
//
//@end
